...
export default class AfterLoginHeader extends React.Component {
  constructor(props) {
    super(props);
            ...
            <Nav className="ml-auto" navbar>
              ...
              <NavItem>
                <UncontrolledDropdown nav inNavbar>
                  ...
                  <DropdownMenu className="text-center">
                    <DropdownItem
                      onClick={this.showModal.bind(this, "Profile")}
                    >
                      Profile
                      <Modal
                        ...
                        toggle={this.closeModal.bind(this, "Profile")}
                      >
                        <ModalBody>
                          ...
                          <Button
                            className="signup"
                            onClick={this.showModal.bind(this, "UpdateProfile")}
                          >
                            Update Profile
                          </Button>
                          <Modal
                            ...
                            aria-labelledby="contained-modal-title-vcenter"
                            centered
                            isOpen={this.state.UpdateProfile}
                            toggle={this.closeModal.bind(this, "UpdateProfile")}
                          >
                            <ModalBody>
                              <Form>
                                <FormGroup className="d-flex text-left align-items-center justify-content-around">
                              ...
                              <Form className="signupForm">
                                <FormGroup>
                                  ...
                                  <div className="password d-flex">
                                    <Input
                                      type={
                                        this.state.hidden ? "text" : "password"
                                      }
                                      name="old-password"
                    ...
                    <DropdownItem
                      onClick={this.showModal.bind(this, "SavedAddress")}
                    >
                      Saved Addresses
                      <Modal
                        ...
                        aria-labelledby="contained-modal-title-vcenter"
                        centered
                        isOpen={this.state.SavedAddress}
                        toggle={this.closeModal.bind(this, "SavedAddress")}
                      >
                        <ModalBody>
                          <Button
                            className="signup px-md-5 my-1 text-left"
                            onClick={this.showModal.bind(this, "NewAddress")}
                          >
                            Add New Address
                          </Button>
                          <h6>Home</h6>
                          <div className="add d-flex align-items-center justify-content-around">
                            <p>
                              Subhrajeet Roy Chowdhury- 551/A, Talbagan, Kolkata
                            </p>
                          ...
                          <Modal
                            ...
                            aria-labelledby="contained-modal-title-vcenter"
                            centered
                            isOpen={this.state.NewAddress}
                            toggle={this.closeModal.bind(this, "NewAddress")}
                          >
                            <ModalBody>
                              <div className="newAddress d-flex align-items-center justify-content-between">
                                <div className="new-address-img">
                                  ...
                                  <p>
                                    Lorem ipsum dolor sit amet. Ut velit nulla
                                    hic ullam dolor non dolorem voluptatem ea
                                    iure rerum et dolores deserunt eos
                                    perspiciatis quia. Sed nostrum pariatur et
                                    placeat vitae et esse quam id nobis
                                    accusamus.
                                  </p>
                                </div>
                                <Form className="signupForm">
                                  ...
                                  <p>
                                    This allow us to find you easily and give
                                    you timely delivery experience
                                  </p>
                                  <FormGroup>
                                    <Input
                                      type="text"
                                  ...
                                  <FormGroup>
                                    <Input
                                      type="text"
                                      name="street/society/office-name"
                                      id=""
              ...
              <NavItem className="me-2">
                <UncontrolledDropdown nav inNavbar>
                  ...
                  <DropdownMenu right>
                    <DropdownItem>
                      <span className="fa fa-map-marker"></span>&nbsp;Kolkata,
                      WestBengal, India
                    </DropdownItem>
                    <DropdownItem
                      onClick={this.showModal.bind(this, "SavedAddress")}
                    >
                      <span class="fa fa-map-marker"></span>&nbsp; Change Your
                      Location
                    </DropdownItem>
                  </DropdownMenu>
                </UncontrolledDropdown>
