...
function Cart(props) {
    ...
    const removeMyCart = (productId) => {
        ...
        // console.log(token)
        axios.put(`http://localhost:4000/cart/${productId}`, {}, {
            headers: {
                            ...
                            <div className="item-desc">
                                ...
                                <div className="pricing-remove d-flex align-items-center justify-content-between">
                                    ...
                                    <Button className="btn btn-primary d-flex align-items-center justify-content-around">
                                        <i className="fa fa-minus" onClick={() => onRemoveProduct(pd)} />&nbsp;
                                        {pd?.qty}
                                        &nbsp;<i className="fa fa-plus" onClick={() => onAddProduct(pd)} />
                                    </Button>
                                    <Button className="btn btn-primary" onClick={() => removeMyCart(pd._id)}>Remove</Button>
                                </div>
                            </div>
                        </div>))}
                    ...
                    <div className="row mb-5">
                        <table>
                            ...
                            <tr>
                                ...
                                <td><i className="fa fa-minus" />&nbsp;&#8377; {Number(billingInfo?.totalActualPrice) - Number(billingInfo?.totalCost)}</td>
                            </tr>
                            <tr>
